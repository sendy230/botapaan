...
bot.command('kick',async(ctx)=>{
    ...
    var memberstatus = await bot.telegram.getChatMember(ctx.chat.id, ctx.from.id)
        ...
        if(ctx.chat.type == 'group' || ctx.chat.type == 'supergroup') {
        if (!memberstatus || memberstatus.status == 'creator' || memberstatus.status == 'administrator' || memberstatus.status == 'left'){
            await bot.telegram.kickChatMember(ctx.chat.id, ctx.reply_from_message.from.id).then(result=>{
                 console.log(result)
            })
        }
    }
...
bot.command('ban',async(ctx)=>{
    ...
    var memberstatus = await bot.telegram.getChatMember(ctx.chat.id, ctx.from.id)
        ...
        if (!memberstatus || memberstatus.status == 'creator' || memberstatus.status == 'administrator' || memberstatus.status == 'left'){
            ...
            user_id: ctx.reply_from_message.from.id
            }).then(result=>{
                 console.log(result)
...
bot.command('unban',async(ctx)=>{
    ...
    var memberstatus = await bot.telegram.getChatMember(ctx.chat.id, ctx.from.id)
        ...
        if(ctx.chat.type == 'group' || ctx.chat.type == 'supergroup') {
        if (!memberstatus || memberstatus.status == 'creator' || memberstatus.status == 'administrator' || memberstatus.status == 'left'){
            await bot.telegram.unbanChatMember(ctx.chat.id, ctx.reply_from_message.from.id).then(result=>{
                 console.log(result)
