...
bot.command('reload',async(ctx)=>{
    var botStatus = await ctx.Telegram.ChatMember.status(channelId, ctx.botInfo.id)
    var memberstatus = await bot.Telegram.ChatMember.status(channelId, ctx.from.id)
