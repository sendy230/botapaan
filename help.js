...
\n Jangan lupa gunakan perintah ini untuk jalankan botnya\n<code>pm2 start /path/index.js --watch</code> /path/ adalah tempat dimana aplikasi index.js disimpan dan gunakan web ini untuk monitoring pm2 https://app.pm2.io/
`;
